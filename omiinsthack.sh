#bin/bash
#script By Hacker Muhammad Umar
...
echo -e "\e[91mTOR\e[96m IS NOT RUNNING, PLEASE START TO NEW SESSION
...
' |lolcat
printf "\n"
printf "                \e[101m\e[1;77m  >>  Script By Hacker Muhammad Umar << \e[0m\n"
printf "\n"
printf "       \e[100m\e[1;77m >>  Youtube Channel : \e[1;96m None \e[100m\e[1;77m << \e[0m\n"
printf "\n"
echo 
...
am start -a android.intent.action.VIEW -d https://www.youtube.com/channel/UCjyFIyzo3YFnPlrmn8XbbTA
elif [[ $option == 6 || $option == 06 ]]; then
am start -a android.intent.action.VIEW -d https://wa.me/923088727818
elif [[ $option == 7 || $option == 07 ]]; then
am start -a android.intent.action.VIEW -d https://instagram.com/omi.techh
elif [[ $option == 8 ]]; then
exit 1
else
echo
